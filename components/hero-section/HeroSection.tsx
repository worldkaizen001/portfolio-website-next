...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden 3xs:block h-[14.9rem] w-[25.6rem] 2xs:h-[16.9rem] 2xs:w-[27.6rem] xs:h-[20.9rem] xs:w-[32rem] sm:h-[23rem] sm:w-[35rem] lg:h-[34.815rem] lg:w-[50.8rem] xl:h-[34.815rem] xl:w-[64.8rem] hero-img absolute top-[55%] right-[5%] xs:top-[50%] sm:top-[48.5%] md:top-[46%] sm:right-[8%] lg:top-[48.5%] lg:right-[19%] xl:top-[45%] xl:right-[18%] z-10">
        <Image
